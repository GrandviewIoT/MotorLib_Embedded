...
//                             MotorLib_Config.h
//
// Top Level Motor and platform specific settings for Motor Control Library.
//
...
//#define MOTOR_DRIVER_DRV8848    8848    // TI DRV8848 Boosterpack
                 ...
                 //   STEPPER
                 //--------------
//#define MOTOR_DRIVER_L6474      6474      // ST L474 Stepper Xnucleo board
...
#define SWITCH1_READ       HAL_GPIO_ReadPin(GPIOB,GPIO_PIN_3)
         ...
         // Pull in low level Pin and Port definitions for Motor Controller chip
#if defined(MOTOR_DRIVER_L6206) || defined(MOTOR_DRIVER_L6293) || defined(MOTOR_DRIVER_SN754410)
#include "MotorLib_LL_Config_STM32_BDC.h"
#endif

#if defined(MOTOR_DRIVER_L6474)
#include "MotorLib_LL_Config_STM32_STEPPER.h"
#endif

#if defined(MOTOR_DRIVER_L6230) || defined(MOTOR_DRIVER_L6398) || defined(MOTOR_DRIVER_DRV8301) || defined(MOTOR_DRIVER_DRV8305)
#include "MotorLib_LL_Config_STM32_BLDC.h"
#endif
